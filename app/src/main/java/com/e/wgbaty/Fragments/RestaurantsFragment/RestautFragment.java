 ...
 */
public class RestautFragment extends Fragment {
    RecyclerView recyclerView;
    RestaurantAdapter adapter;
    View myFragment;

    public RestautFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myFragment = inflater.inflate(R.layout.fragment_restaut, container, false);

        recyclerView = myFragment.findViewById(R.id.recycler_restaurant);
